...
<body>
  <?php
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            <h3>Men's <span><?php echo $cat_name; ?></span></h3>
            <!--/w3_short-->
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">

                    <ul class="w3_short">
                            <li><a href="../../index.php">Home</a><i>|</i><a href="../../products/men/men-all.php"> <?php echo $_GET['MF']; ?> Wear</a><i>|</i></li>
                ...
                <div class="sign-grds">
                    <div class="col-md-5 sign-gd">
                        ...
                        <ul>
                                ...
                                <li><a href="../../products/women/index.php">Women's wear</a></li>
