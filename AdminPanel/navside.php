					...
					<ul class="dropdown-menu">
					  ...
					  <li class="user-footer">
						...
						<div class="pull-right">
						  <a href="#" id="logout" class="btn" style="background-color:#1c191b!important; color:thistle; text-shadow:0px 0px 1px #e50000; font-family:cursive; box-shadow:0px 0px 9px white;">Sign out</a>
						</div>
					  </li>
					</ul>
				  </li>  
