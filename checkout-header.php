...
<div class="w3-sidebar w3-bar-block w3-animate-right" style="width:400px;right:0;display:none;z-index:4" id="mySidebar">
           <!--  <button class="w3-bar-item w3-button "
            onclick="w3_close()">Close &times;</button> --> 
            <h4 style="background-color:#7b2b63;color:#dbdc89;padding-top:10px;padding-bottom:10px;text-align:center;margin-bottom:20px;">Review Items</h4>
           <div id="side-item-review">
          ...
          <div id="id01" class="w3-modal">
                <div class="w3-modal-content">
                  <div class="w3-container">
                    ...
                    <img src="images/loader.gif" alt="" style="vertical-align:inherit">
                </div>
                <div class="w3-col m7 l7">
                    <h2 style="margin-top:100px;color:#7b2b63;">Congrats! Transaction Successful</h2>
                    <h5 style="margin-top:15px;padding-left:20px">Redirecting to home page ...</h5>
                </div>
        ...
        <div class="container">
            <div class="top_nav_left">
                <nav class="navbar navbar-default">
					...
					<span class="icon-bar"></span>
                        ...
                        <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav menu__list">
                                <li class=" menu__item" id="index"><a class="menu__link" href="index.php">Home <span class="sr-only">(current)</span></a></li>
                                    ...
                                    <ul class="dropdown-menu multi-column columns-3">
                                        <div class="agile_inner_drop_nav_info">
                                            ...
                                            <div class="col-sm-6 multi-gd-img multi-gd-text ">
                                                <a href="products/women/index.php"><img src="images/top1.jpg" alt=" "/></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
				 ...
				 <?php
    				echo '<script> document.getElementById("'.$highlight.'").className+=" "; </script>';  
  				 ?>
            </div>
